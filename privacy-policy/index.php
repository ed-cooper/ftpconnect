...
<html>
    <head>
        <!-- Title -->
        <title>FTP Connect - Privacy Policy</title>
        
        <!-- SEO -->
        <meta name="description" content="FTP Connect - Privacy Policy">
    ...
    <body>
        ...
        <div id="main">
            ...
            <p>
                ...
                processes, stores and protects user data and information will
            ...
            <p>
                ...
                and referral tracking and typically expire after 30 days,
                though some may take longer. No personal information is stored,
                saved or collected.
            </p>
            <h2>
            ...
            <p>
                ...
                website operates but only if this was made clear to you and
                your express permission was granted when submitting any form
                to email process. Or whereby you the consumer have previously
                purchased from or enquired about purchasing from the company a
                product or service that the email newsletter relates to. This
                is by no means an entire list of your user rights in regard to
                receiving email marketing material. Your details are not passed
            ...
            <ul>
                <li>
                    <a href="http://www.legislation.gov.uk/ukpga/1998/29/contents">Data Protection Act 1998</a>
                </li>
                <li>
                    <a href="http://www.google.com/privacy.html">Google Privacy Policy</a>
                </li>
                <li>
                    <a href="http://www.jamieking.co.uk/resources/free_sample_privacy_policy.html">Website Privacy Policy Template</a>
                </li>
            </ul>
            <p>
                v1.0 November 2016 Edited & customised by Chooper100
            </p>
            <p>
